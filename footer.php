	<footer id="footer">
				<div class="flex">
					<div>
						<dl>
							...
							<dd><a href="<?php echo home_url(); ?>/shop/#saitama">埼玉県</a></dd>
		...
		<script src="<?php echo get_stylesheet_directory_uri().'/js/func_acdh.js'; echo '?' . filemtime(get_stylesheet_directory() . '/js/func_acdh.js'); ?>"></script>
		<?php wp_footer(); ?>
	</body>
</html>
